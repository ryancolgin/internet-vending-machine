...
export const products: Product[] = [
  ...
  },
  {
    ...
    slotImage: "/products/excalidraw-slot.webp",
    slotSourceImage: "/products/excalidraw-slot.webp",
    productImages: [
      { src: "/products/excalidraw-1.webp", fit: "contain" },
      { src: "/products/excalidraw-2.webp", fit: "contain" },
      { src: "/products/excalidraw-3.webp", fit: "contain" },
    ],
    machineCopy:
  ...
  {
    id: "level8-packing-cubes",
    name: "Packing Cube Travel Set (4 pack)",
    brand: "LEVEL8",
    shortName: "Packing Cubes 4-pack",
    type: "physical",
    category: "travel",
    tags: ["travel", "packing", "luggage", "organization"],
    price: 49.99,
    priceLabel: "$49.99",
    source: "LEVEL8",
    ...
    machineCopy:
      "A four-cube packing set for garments, gadgets, and grooming. Two-tone polyester that repels water, with detachable tags so you can tell which cube is which.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-08-20",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "xteink-x4-pro",
    name: "XTEINK X4 Pro Pocket eReader",
    brand: "XTEINK",
    shortName: "X4 Pro",
    type: "physical",
    category: "carry",
    tags: ["reading", "e-ink", "pocket", "travel"],
    price: 99,
    priceLabel: "$99.00",
    source: "XTEINK",
    ...
    productImages: [
      ...
      { src: "/products/xteink-x4-pro-night.jpg", fit: "cover" },
    ],
    machineCopy:
      "A pocket-sized eReader built for distraction-free reading. Small enough to carry easily, with a minimalist e-ink display for reading on the go or at night.",
    status: "active",
    badges: ["new"],
  ...
  {
    id: "wiim-sound-lite",
    name: "WiiM Sound Lite",
    brand: "WiiM",
    shortName: "Sound Lite",
    type: "physical",
    category: "home",
    tags: ["audio", "speaker", "streaming", "multi-room"],
    price: 229,
    priceLabel: "$229",
    source: "WiiM",
  ...
  {
    id: "level8-atlas-laptop-backpack",
    name: "Atlas Laptop Backpack",
    brand: "LEVEL8",
    shortName: "Atlas Backpack",
    type: "physical",
    category: "travel",
    tags: ["backpack", "travel", "laptop", "organization", "everyday-carry"],
    price: 129.99,
    priceLabel: "$129.99",
    source: "LEVEL8",
    sourceUrl:
  ...
  {
    id: "level8-element-toiletry-case",
    name: "Element Toiletry Case",
    brand: "LEVEL8",
    shortName: "Element Toiletry Case",
    type: "physical",
    category: "travel",
    tags: ["travel", "toiletry", "organization", "carry"],
    price: 59.99,
    priceLabel: "$59.99",
    source: "LEVEL8",
    ...
    machineCopy:
      "A compact travel case with structured storage for toiletries and small essentials, designed to keep everything organized and easy to reach.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-08-21",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "bludot-ends-trays",
    name: "Ends Trays",
    brand: "Blu Dot",
    shortName: "Ends Trays",
    type: "physical",
    category: "home",
    tags: ["home", "desk", "organization", "design"],
    price: 75,
    priceLabel: "$75.00",
    source: "Blu Dot",
    ...
    productImages: [
      ...
      { src: "/products/bludot-ends-trays-3.webp", fit: "contain" },
    ],
    machineCopy:
      "A powder-coated steel trio for the pocket dump. Nested trays, cork pads, and color that makes keys and clips look considered.",
    status: "active",
    badges: ["new"],
  ...
  },
  {
    ...
    productImages: [
      ...
      { src: "/products/bludot-100-trays-3.webp", fit: "contain" },
    ],
    machineCopy:
      "Three steel trays that nest or stand apart. Jewelry, keys, sunglasses, and the rest of the counter clutter, given a place.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-08-26",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "bludot-square-one-organizer-tray",
    name: "Square One Organizer Tray",
    brand: "Blu Dot",
    shortName: "Square One Tray",
    type: "physical",
    category: "home",
    tags: ["home", "desk", "organization", "wood"],
    price: 50,
    priceLabel: "$50.00",
    source: "Blu Dot",
    ...
    machineCopy:
      "A beveled wood organizer with rooms for pens, clips, and the workday scatter. One tidy square that earns the desk.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-08-26",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "bludot-2d3d-large-bowl",
    name: "2D:3D Large Bowl",
    brand: "Blu Dot",
    shortName: "2D3D Bowl",
    type: "physical",
    category: "home",
    tags: ["home", "design", "sculptural"],
    price: 110,
    priceLabel: "$110.00",
    source: "Blu Dot",
    ...
    productImages: [
      ...
      { src: "/products/minimalist_white_hexagonal_tray.webp", fit: "contain" },
    ],
    machineCopy:
      "A copper bowl that ships flat and folds into shape. Sculptural origami for the table — useful full, still good empty.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-08-26",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "bludot-odds-trays",
    name: "Odds Trays",
    brand: "Blu Dot",
    shortName: "Odds Trays",
    type: "physical",
    category: "home",
    tags: ["home", "desk", "organization", "wood"],
    price: 85,
    ...
    productImages: [
      ...
      { src: "/products/stacked_wooden_organizer_tray_set.webp", fit: "contain" },
    ],
    machineCopy:
      "Bent-wood trays in a small trio for the odds that collect. Pocket dump, without looking like one.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-08-26",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "bludot-less-is-more-difficult-book",
    name: "Blu Dot Book: Less Is More (Difficult)",
    brand: "Blu Dot",
    shortName: "Less Is More",
    type: "physical",
    category: "reference",
    tags: ["book", "design", "home"],
    price: 90,
    priceLabel: "$90.00",
    source: "Blu Dot",
  ...
  {
    id: "satechi-onthego-7-in-1",
    name: "OntheGo™ 7-in-1 Multiport Adapter",
    brand: "Satechi",
    shortName: "OntheGo 7-in-1",
    type: "physical",
    category: "tech",
    tags: ["tech", "usb-c", "adapter", "hub", "travel", "desk"],
    price: 59.99,
    priceLabel: "$59.99",
    source: "Satechi",
    ...
    productImages: [
      ...
      { src: "/products/satechi-onthego-7-in-1-multiport-adapter-3.webp", fit: "cover" },
    ],
    machineCopy:
      "A puck hub that magnetically parks on the laptop lid. HDMI, Ethernet, SD, two USB-A, and a cable that wraps around the body.",
    status: "active",
    badges: ["new"],
  ...
  {
    id: "satechi-qi2-trio",
    name: "Qi2 Trio Wireless Charging Pad",
    brand: "Satechi",
    shortName: "Qi2 Trio",
    type: "physical",
    category: "tech",
    tags: ["tech", "charging", "qi2", "iphone", "apple-watch", "airpods", "desk"],
    price: 129.99,
    priceLabel: "$129.99",
    source: "Satechi",
  ...
  {
    id: "satechi-onthego-3-in-1",
    name: "OntheGo™ 3-in-1 Charger",
    brand: "Satechi",
    shortName: "OntheGo 3-in-1",
    type: "physical",
    category: "tech",
    tags: ["tech", "charging", "qi2", "travel", "iphone", "apple-watch", "airpods"],
    price: 99.99,
    priceLabel: "$99.99",
    source: "Satechi",
  ...
  {
    id: "satechi-onthego-67w",
    name: "OntheGo™ 67W Slim Wall Charger",
    brand: "Satechi",
    shortName: "OntheGo 67W",
    type: "physical",
    category: "tech",
    tags: ["tech", "charging", "usb-c", "gan", "travel"],
    price: 59.99,
    priceLabel: "$59.99",
    source: "Satechi",
    ...
    machineCopy:
      "A 67W GaN brick thin enough to leave in the outlet. Two USB-C ports, fold-flat prongs, and a face that does not look like a power supply.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-08-27",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "satechi-findall-card",
    name: "FindAll™ Card",
    brand: "Satechi",
    shortName: "FindAll Wallet Card",
    type: "physical",
    category: "travel",
    tags: ["travel", "wallet", "tracking", "apple-find-my", "rechargeable"],
    price: 34.99,
    priceLabel: "$34.99",
    source: "Satechi",
  ...
  {
    id: "satechi-findall-passport-cover",
    name: "Vegan-Leather FindAll™ Passport Cover",
    brand: "Satechi",
    shortName: "FindAll Passport",
    type: "physical",
    category: "travel",
    tags: ["travel", "passport", "tracking", "apple-find-my", "organization"],
    price: 59.99,
    priceLabel: "$59.99",
    source: "Satechi",
    ...
    productImages: [
      ...
      { src: "/products/satechi-findall-passport-cover-3.webp", fit: "cover" },
    ],
    machineCopy:
      "A vegan-leather passport wallet with Find My built in. Cards, boarding pass, and a cover that can ping itself.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-08-27",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "satechi-findall-keychain",
    name: "Vegan-Leather FindAll™ Keychain",
    brand: "Satechi",
    shortName: "FindAll Keychain",
    type: "physical",
    category: "travel",
    tags: ["travel", "keys", "tracking", "apple-find-my", "everyday-carry"],
    price: 29.99,
    priceLabel: "$29.99",
    source: "Satechi",
    ...
    productImages: [
      ...
      { src: "/products/satechi-findall-keychain-3.webp", fit: "contain" },
    ],
    machineCopy:
      "A pebble of vegan leather on a ring. Find My for the keys that vanish between the couch and the door.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-08-27",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "satechi-findall-luggage-tag",
    name: "Vegan-Leather FindAll™ Luggage Tag",
    brand: "Satechi",
    shortName: "FindAll Luggage Tag",
    type: "physical",
    category: "travel",
    tags: ["travel", "luggage", "tracking", "apple-find-my"],
    price: 44.99,
    priceLabel: "$44.99",
    source: "Satechi",
    ...
    productImages: [
      ...
      { src: "/products/satechi-findall-luggage-tag-3.webp", fit: "contain" },
      { src: "/products/satechi-findall-luggage-tag-4.webp", fit: "cover" },
    ],
    machineCopy:
      "A leather luggage tag that also reports in. ID card, buckle strap, and Find My if the bag goes left instead of right.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-08-27",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "satechi-findall-glasses-case",
    name: "Vegan-Leather FindAll™ Glasses Case",
    brand: "Satechi",
    shortName: "FindAll Glasses Case",
    type: "physical",
    category: "travel",
    tags: ["travel", "glasses", "tracking", "apple-find-my", "organization"],
    price: 49.99,
    priceLabel: "$49.99",
    source: "Satechi",
  ...
  {
    id: "polaroid-now-gen-3",
    name: "Polaroid Now Instant Camera Gen 3",
    brand: "Polaroid",
    shortName: "Polaroid Now Camera",
    type: "physical",
    category: "photo",
    tags: ["photo", "camera", "instant", "polaroid"],
    price: 129.99,
    priceLabel: "$129.99",
    source: "Polaroid",
    sourceUrl: "https://polaroid.pxf.io/KBGXex?u=https://www.polaroid.com/en_us/products/polaroid-now/yellow",
    illustration: "camera",
    slotImage: "/products/polaroid-now-gen-3-slot.webp",
    slotSourceImage: "/products/polaroid-now-gen-3-1.webp",
    productImages: [{ src: "/products/polaroid-now-gen-3-1.webp", fit: "contain" }],
    machineCopy:
      "The classic instant camera, updated. Autofocus, USB-C, and a yellow body that reads from across the room.",
    status: "active",
    badges: ["new"],
  ...
  {
    id: "polaroid-go-gen-2",
    name: "Polaroid Go Instant Camera Gen 2",
    brand: "Polaroid",
    shortName: "Go Gen 2",
    type: "physical",
    category: "photo",
    tags: ["photo", "camera", "instant", "polaroid", "gift"],
    price: 89.99,
    priceLabel: "$89.99",
    source: "Polaroid",
    sourceUrl: "https://polaroid.pxf.io/KBGXex?u=https://www.polaroid.com/en_us/products/go-polaroid-camera-generation-2/blue",
    illustration: "camera",
    slotImage: "/products/polaroid-go-gen-2-slot.webp",
    slotSourceImage: "/products/polaroid-go-gen-2-1.webp",
    productImages: [
      { src: "/products/polaroid-go-gen-2-1.webp", fit: "contain" },
      { src: "/products/polaroid-go-gen-2-2.webp", fit: "contain" },
      { src: "/products/polaroid-go-gen-2-3.webp", fit: "contain" },
    ],
    machineCopy:
      "The pocket Polaroid. Mini film, USB-C, and small enough to gift without looking like a gadget.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-09-10",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "polaroid-now-plus-gen-3",
    name: "Polaroid Now+ Instant Camera Gen 3",
    brand: "Polaroid",
    shortName: "Now+ Gen 3",
    type: "physical",
    category: "photo",
    tags: ["photo", "camera", "instant", "polaroid", "app"],
    price: 149.99,
    priceLabel: "$149.99",
    source: "Polaroid",
    sourceUrl: "https://polaroid.pxf.io/KBGXex?u=https://www.polaroid.com/en_us/products/now-plus-polaroid-camera/coral",
    illustration: "camera",
    slotImage: "/products/polaroid-now-plus-gen-3-slot.webp",
    slotSourceImage: "/products/polaroid-now-plus-gen-3-1.webp",
    productImages: [{ src: "/products/polaroid-now-plus-gen-3-1.webp", fit: "contain" }],
    machineCopy:
      "The Now with a + button and an app. Double exposure, timers, and a few extra levers if you want them.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-09-10",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "polaroid-i-2",
    name: "Polaroid I-2 Instant Camera",
    brand: "Polaroid",
    shortName: "I-2",
    type: "physical",
    category: "photo",
    tags: ["photo", "camera", "instant", "polaroid", "manual"],
    price: 599.99,
    priceLabel: "$599.99",
    source: "Polaroid",
    sourceUrl: "https://polaroid.pxf.io/KBGXex?u=https://www.polaroid.com/en_us/products/i2-polaroid-camera/black",
    illustration: "camera",
    slotImage: "/products/polaroid-i-2-slot.webp",
    slotSourceImage: "/products/polaroid-i-2-1.webp",
    productImages: [
      { src: "/products/polaroid-i-2-1.webp", fit: "contain" },
      { src: "/products/polaroid-i-2-2.webp", fit: "contain" },
      { src: "/products/polaroid-i-2-3.webp", fit: "contain" },
    ],
    machineCopy:
      "Polaroid's enthusiast camera. Manual aperture, lidar focus, and the one you buy when the Now stops being enough.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-09-10",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "polaroid-lab",
    name: "Polaroid Lab Printer",
    brand: "Polaroid",
    shortName: "Polaroid Lab",
    type: "physical",
    category: "photo",
    tags: ["photo", "printer", "instant", "polaroid"],
    price: 139.99,
    priceLabel: "$139.99",
    source: "Polaroid",
    sourceUrl: "https://polaroid.pxf.io/KBGXex?u=https://www.polaroid.com/en_us/products/polaroid-lab",
    illustration: "camera",
    slotImage: "/products/polaroid-lab-slot.webp",
    slotSourceImage: "/products/polaroid-lab-1.webp",
    productImages: [
      { src: "/products/polaroid-lab-1.webp", fit: "contain" },
      { src: "/products/polaroid-lab-2.webp", fit: "contain" },
      { src: "/products/polaroid-lab-3.webp", fit: "contain" },
    ],
    machineCopy:
      "A phone dock that prints real Polaroids. Weird, delightful, and the one that doesn't need a camera body.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-09-10",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "polaroid-now-gen-3-moma",
    name: "Polaroid Now Gen 3 – MoMA Edition",
    brand: "Polaroid",
    shortName: "Now MoMA",
    type: "physical",
    category: "photo",
    tags: ["photo", "camera", "instant", "polaroid", "edition"],
    price: 129.99,
    priceLabel: "$129.99",
    source: "Polaroid",
    sourceUrl: "https://polaroid.pxf.io/KBGXex?u=https://www.polaroid.com/en_us/products/polaroid-now-moma-edition",
    illustration: "camera",
    slotImage: "/products/polaroid-now-gen-3-moma-slot.webp",
    slotSourceImage: "/products/polaroid-now-gen-3-moma-1.webp",
    productImages: [{ src: "/products/polaroid-now-gen-3-moma-1.webp", fit: "contain" }],
    machineCopy:
      "A Now Gen 3 in museum blue, with a MoMA wordmark and a strap that looks borrowed from the gift shop.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-09-10",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "polaroid-small-photo-album",
    name: "Polaroid Small Photo Album",
    brand: "Polaroid",
    shortName: "Polaroid Album",
    type: "physical",
    category: "photo",
    tags: ["photo", "album", "instant", "polaroid"],
    price: 14.99,
    priceLabel: "$14.99",
    source: "Polaroid",
    sourceUrl: "https://polaroid.pxf.io/KBGXex?u=https://www.polaroid.com/en_us/products/polaroid-photo-album-small",
    illustration: "notebook",
    slotImage: "/products/polaroid-small-photo-album-slot.webp",
    slotSourceImage: "/products/polaroid-small-photo-album-1.webp",
    productImages: [
      { src: "/products/polaroid-small-photo-album-1.webp", fit: "contain" },
      { src: "/products/polaroid-small-photo-album-2.webp", fit: "contain" },
      { src: "/products/polaroid-small-photo-album-3.webp", fit: "cover" },
    ],
    machineCopy:
      "A small book for the prints that otherwise live in a drawer. Polaroid-shaped, cheap, and the reason the stack stays a stack.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-09-10",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "nalgene-32oz-wide-mouth",
    name: "32oz Wide Mouth Bottle",
    brand: "Nalgene",
    shortName: "32oz Wide Mouth",
    type: "physical",
    category: "travel",
    tags: ["travel", "bottle", "everyday"],
    price: 16.99,
    priceLabel: "$16.99",
    source: "Nalgene",
    sourceUrl:
      "https://nalgene.pxf.io/c/7640638/1104884/12848?prodsku=woocommerce_gpf_731874&u=https%3A%2F%2Fnalgene.com%2Fproduct%2F32oz-wide-mouth-bottle%2F%3Fattribute_pa_color%3Dviolet&intsrc=APIG_8574",
    illustration: "bottle",
    slotImage: "/products/nalgene-32oz-wide-mouth-slot.webp",
    slotSourceImage: "/products/nalgene-32oz-wide-mouth-1.webp",
    productImages: [
      { src: "/products/nalgene-32oz-wide-mouth-1.webp", fit: "contain" },
      { src: "/products/nalgene-32oz-wide-mouth-2.webp", fit: "contain" },
      { src: "/products/nalgene-32oz-wide-mouth-3.webp", fit: "cover" },
    ],
    machineCopy:
      "The bottle people mean when they say Nalgene: simple, nearly indestructible, leakproof, and sized for a full day.",
    status: "active",
    badges: ["new"],
  ...
  {
    id: "nalgene-freshflow-24oz",
    name: "24oz FreshFlow Straw Bottle",
    brand: "Nalgene",
    shortName: "FreshFlow 24oz",
    type: "physical",
    category: "travel",
    tags: ["travel", "bottle", "straw"],
    price: 18.99,
    priceLabel: "$18.99",
    source: "Nalgene",
    sourceUrl:
      "https://nalgene.pxf.io/c/7640638/1104884/12848?prodsku=woocommerce_gpf_863026&u=https%3A%2F%2Fnalgene.com%2Fproduct%2F24oz-freshflow-straw-bottle%2F%3Fattribute_pa_graphic%3Daqua-with-blue-cap&intsrc=APIG_8574",
    illustration: "bottle",
    slotImage: "/products/nalgene-freshflow-24oz-slot.webp",
    slotSourceImage: "/products/nalgene-freshflow-24oz-1.webp",
    productImages: [
      { src: "/products/nalgene-freshflow-24oz-1.webp", fit: "contain" },
      { src: "/products/nalgene-freshflow-24oz-2.webp", fit: "contain" },
      { src: "/products/nalgene-freshflow-24oz-3.webp", fit: "contain" },
    ],
    machineCopy:
      "A 24oz Nalgene with a removable straw and a lid that opens three ways. Gym, car, desk — not another trail bottle.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-09-11",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "nalgene-on-the-fly-24oz",
    name: "24oz On-The-Fly Lock-Top Bottle",
    brand: "Nalgene",
    shortName: "On-The-Fly 24oz",
    type: "physical",
    category: "travel",
    tags: ["travel", "bottle", "commute"],
    price: 17.99,
    priceLabel: "$17.99",
    source: "Nalgene",
    sourceUrl:
      "https://nalgene.pxf.io/c/7640638/1104884/12848?prodsku=woocommerce_gpf_673229&u=https%3A%2F%2Fnalgene.com%2Fproduct%2F24oz-on-the-fly-lock-top-sustain-bottle%2F%3Fattribute_pa_color%3Djuniper-with-juniper-orange-cap&intsrc=APIG_8574",
    illustration: "bottle",
    slotImage: "/products/nalgene-on-the-fly-24oz-slot.webp",
    slotSourceImage: "/products/nalgene-on-the-fly-24oz-1.webp",
    productImages: [
      { src: "/products/nalgene-on-the-fly-24oz-1.webp", fit: "contain" },
      { src: "/products/nalgene-on-the-fly-24oz-2.webp", fit: "contain" },
      { src: "/products/nalgene-on-the-fly-24oz-3.webp", fit: "cover" },
    ],
    machineCopy:
      "A lock-top 24oz you can drink from one-handed. The lid stays shut in a bag and flips open when you actually want water.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-09-11",
    metrics: { ...emptyMetrics },
  },
  {
    ...
    type: "physical",
    category: "travel",
    tags: ["travel", "bottle", "limited"],
    price: 18.99,
    priceLabel: "$18.99",
    source: "Nalgene",
    sourceUrl:
      "https://nalgene.pxf.io/c/7640638/1104884/12848?prodsku=woocommerce_gpf_821929&u=https%3A%2F%2Fnalgene.com%2Fproduct%2F32oz-wm-glowyld%2F%3Fattribute_pa_graphic%3Dblack-turtle&intsrc=APIG_8574",
    illustration: "bottle",
    slotImage: "/products/nalgene-glo-wyld-slot.webp",
    slotSourceImage: "/products/nalgene-glo-wyld-1.webp",
    productImages: [
      { src: "/products/nalgene-glo-wyld-1.webp", fit: "contain" },
      { src: "/products/nalgene-glo-wyld-2.webp", fit: "contain" },
      { src: "/products/nalgene-glo-wyld-3.webp", fit: "contain" },
    ],
    machineCopy:
      "A classic 32oz Nalgene that glows in the dark. Because apparently a water bottle can have a night mode.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-09-11",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "nalgene-stained-glass",
    name: "32oz Stained Glass Print Bottle",
    brand: "Nalgene",
    shortName: "Nalgene Stained Glass",
    type: "physical",
    category: "travel",
    tags: ["travel", "bottle", "print"],
    price: 18.99,
    priceLabel: "$18.99",
    source: "Nalgene",
    sourceUrl:
      "https://nalgene.pxf.io/c/7640638/1104884/12848?prodsku=woocommerce_gpf_761803&u=https%3A%2F%2Fnalgene.com%2Fproduct%2F32oz-wide-mouth-stained-glass-print-bottles%2F%3Fattribute_pa_graphic%3Ddesert&intsrc=APIG_8574",
    illustration: "bottle",
    slotImage: "/products/nalgene-stained-glass-slot.webp",
    slotSourceImage: "/products/nalgene-stained-glass-1.webp",
    productImages: [
      { src: "/products/nalgene-stained-glass-1.webp", fit: "contain" },
      { src: "/products/nalgene-stained-glass-2.webp", fit: "contain" },
      { src: "/products/nalgene-stained-glass-3.webp", fit: "contain" },
    ],
    machineCopy:
      "A 32oz wide-mouth printed like a desert window. Same bottle, different reason to pick it up.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-09-11",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "nalgene-10oz-flask",
    name: "10oz Flask",
    brand: "Nalgene",
    shortName: "10oz Flask",
    type: "physical",
    category: "carry",
    tags: ["carry", "compact", "bottle"],
    price: 9.91,
    priceLabel: "$9.91",
    source: "Nalgene",
    sourceUrl:
      "https://nalgene.pxf.io/c/7640638/1104884/12848?prodsku=woocommerce_gpf_1053&u=https%3A%2F%2Fnalgene.com%2Fproduct%2F10oz-flask%2F%3Fattribute_pa_color%3Dblue&intsrc=APIG_8574",
    illustration: "bottle",
    slotImage: "/products/nalgene-10oz-flask-slot.webp",
    slotSourceImage: "/products/nalgene-10oz-flask-1.webp",
    productImages: [{ src: "/products/nalgene-10oz-flask-1.webp", fit: "contain" }],
    machineCopy:
      "A flat 10oz Nalgene that sits in a pocket like a flask. Not a day's water — a compact, leakproof oddity.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-09-11",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "nalgene-cantene-48oz",
    name: "48oz Nalgene Cantene",
    brand: "Nalgene",
    shortName: "48oz Cantene",
    type: "physical",
    category: "travel",
    tags: ["travel", "camping", "collapsible"],
    price: 19.32,
    priceLabel: "$19.32",
    source: "Nalgene",
    sourceUrl:
      "https://nalgene.pxf.io/c/7640638/1104884/12848?prodsku=woocommerce_gpf_963&u=https%3A%2F%2Fnalgene.com%2Fproduct%2F48oz-nalgene-cantene%2F&intsrc=APIG_8574",
    illustration: "bottle",
    slotImage: "/products/nalgene-cantene-48oz-slot.webp",
    slotSourceImage: "/products/nalgene-cantene-48oz-1.webp",
    productImages: [{ src: "/products/nalgene-cantene-48oz-1.webp", fit: "contain" }],
    machineCopy:
      "A 48oz collapsible camping jug, not the rigid Silo. Folds flat when empty, gusseted base so it stands when you fill it.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-09-11",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "nalgene-travel-kit",
    name: "Travel Kit with Bag",
    brand: "Nalgene",
    shortName: "Travel Kit",
    type: "physical",
    category: "travel",
    tags: ["travel", "toiletry", "kit"],
    price: 18.89,
    priceLabel: "$18.89",
    source: "Nalgene",
    sourceUrl:
      "https://nalgene.pxf.io/c/7640638/1104884/12848?prodsku=woocommerce_gpf_1008&u=https%3A%2F%2Fnalgene.com%2Fproduct%2Ftravel-kit-with-bag%2F&intsrc=APIG_8574",
    illustration: "kit",
    slotImage: "/products/nalgene-travel-kit-slot.webp",
    slotSourceImage: "/products/nalgene-travel-kit-1.webp",
    inspectorFit: "cover",
    productImages: [{ src: "/products/nalgene-travel-kit-1.webp", fit: "cover" }],
    machineCopy:
      "Four 2oz squares, a 1oz jar, a swab vial, and a bag. Nalgene's leakproof habit, pointed at the toiletry problem.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-09-11",
    metrics: { ...emptyMetrics },
  ...
  {
    id: "nalgene-geyser-clean-kit",
    name: "Geyser Outdoor Clean Kit",
    brand: "Nalgene",
    shortName: "Geyser Clean Kit",
    type: "physical",
    category: "wildcard",
    tags: ["wildcard", "outdoor", "travel", "utility"],
    price: 99.99,
    priceLabel: "$99.99",
    source: "Nalgene",
    sourceUrl:
  ...
  {
    id: "nalgene-storage-jar-32oz",
    name: "32oz Storage Jar",
    brand: "Nalgene",
    shortName: "32oz Storage Jar",
    type: "physical",
    category: "home",
    tags: ["home", "storage", "utility"],
    price: 7.29,
    priceLabel: "$7.29",
    source: "Nalgene",
    sourceUrl:
      "https://nalgene.pxf.io/c/7640638/1104884/12848?prodsku=woocommerce_gpf_736946&u=https%3A%2F%2Fnalgene.com%2Fproduct%2F32oz-storage-jar-blue-lid%2F&intsrc=APIG_8574",
    illustration: "tray",
    slotImage: "/products/nalgene-storage-jar-32oz-slot.webp",
    slotSourceImage: "/products/nalgene-storage-jar-32oz-1.webp",
    productImages: [
      { src: "/products/nalgene-storage-jar-32oz-1.webp", fit: "contain" },
      { src: "/products/nalgene-storage-jar-32oz-2.webp", fit: "cover" },
    ],
    machineCopy:
      "A 32oz airtight jar that stacks. Same plastic stubbornness as the bottles, pointed at leftovers and camp food instead of water.",
    status: "active",
    badges: ["new"],
    addedDate: "2026-09-11",
    metrics: { ...emptyMetrics },
  ...
  },
  {
    ...
    productImages: [
      ...
      { src: "/products/stimeez-emotion-explorers-3.webp", fit: "contain" },
    ],
    machineCopy:
